...
function AboutText(): JSX.Element {
  return (
    <div className="col-span-2 mx-4 group">
      <p className="uppercase text-sm tracking-[0.3em] text-gray-500 text-center xl:text-start font-luxury flex items-center gap-2 justify-center xl:justify-start">
        <span className="w-8 h-[1px] bg-gray-500 hidden xl:block"></span>
        About Me
      </p>
      <h2 className="py-4 text-center xl:text-start uppercase tracking-wider text-3xl font-luxury bg-gradient-to-r from-white to-gray-500 bg-clip-text text-transparent">
      ...
      <div className="space-y-10 mt-8 relative">
        ...
        <section className="xl:pl-8 relative group/section">
          ...
          <div className="flex items-center gap-3 mb-3">
            <HiOutlineLightBulb className="text-gray-400 text-lg" />
            <h3 className="text-gray-400 font-luxury text-xs uppercase tracking-widest italic">The Nexus of Tech & Arts</h3>
          </div>
          <p className="text-gray-300 font-premium leading-relaxed text-lg">
        ...
        <section className="xl:pl-8 relative group/section">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-gray-400 font-luxury text-xs uppercase tracking-widest italic">Community & Connection</h3>
          </div>
          <p className="text-gray-300 font-premium leading-relaxed text-lg">
        ...
        <section className="xl:pl-8 relative group/section">
          ...
          <div className="flex items-center gap-3 mb-3">
            <HiOutlinePresentationChartLine className="text-gray-400 text-lg" />
            <h3 className="text-gray-400 font-luxury text-xs uppercase tracking-widest italic">The Entrepreneurial Crucible</h3>
          </div>
          <p className="text-gray-300 font-premium leading-relaxed text-lg">
        ...
        <section className="xl:pl-8 relative group/section">
          ...
          <div className="flex items-center gap-3 mb-3">
            <HiOutlineAcademicCap className="text-gray-400 text-lg" />
            <h3 className="text-gray-400 font-luxury text-xs uppercase tracking-widest italic">Intellectual Growth & Private Study</h3>
          </div>
          <p className="text-gray-300 font-premium leading-relaxed text-lg">
        ...
        <section className="xl:pl-8 relative group/section">
          ...
          <div className="flex items-center gap-3 mb-3">
            <HiOutlineGlobeAlt className="text-gray-400 text-lg" />
            <h3 className="text-gray-400 font-luxury text-xs uppercase tracking-widest italic">Vision & Global Influence</h3>
          </div>
          <p className="text-gray-300 font-premium leading-relaxed text-lg">
      ...
      <Link href="/#projects" scroll={false}>
        <p className="py-12 text-gray-400 underline cursor-pointer hover:text-white transition-all font-luxury tracking-[0.4em] text-xs uppercase text-center xl:text-start flex items-center justify-center xl:justify-start gap-4">
          Explore My Portfolio
          <span className="w-12 h-[1px] bg-gray-600 group-hover:w-20 group-hover:bg-white transition-all duration-500"></span>
        </p>
      </Link>
    </div>
  );
